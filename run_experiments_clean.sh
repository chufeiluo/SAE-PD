...
#   ./run_experiments_clean.sh --submit prompting
#   ./run_experiments_clean.sh --submit steering
#   ./run_experiments_clean.sh --submit sweep
#
#   # List experiments without running:
#   ./run_experiments_clean.sh --list prompting
#
#   # Run locally (non-SLURM):
#   ./run_experiments_clean.sh --local prompting
#
